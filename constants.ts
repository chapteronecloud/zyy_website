...
export const CONTENT: DataStore = {
  [Language.EN]: {
    ...
    hero: {
      ...
      intro: "Incoming NUS Msc DSML Candidate | CUFE FinTech Student. Integrating advanced software engineering (Python, C++, SQL) with financial theory, with experience in multi-factor models, NLP-based risk systems, and high-frequency strategy backtesting",
      cta: "Contact Me",
...
Assisted in the Low-Altitude Economy research, independently analysing two companies, focusing on investment value and corporate strategy separately, and proposed investment and strategic recommendations.`
  ...
  [Language.CN]: {
    ...
    hero: {
      ...
      title: "金融科技 / 量化金融",
      subtitle: "数据驱动 · 量化赋能",
      intro: "中央财经大学金融科技专业，即将入读 NUS 数据科学与机器学习DSML 项目。 兼具扎实的数理统计基础与 Python/C++ 编程能力，曾在多家机构完成多因子模型构建、NLP 情感分析及策略回测归因等实战项目。",
      cta: "联系我",
